namespace Midterm_Project_The_Matching_Game_ {
    ...
    /// <summary>
    /// Interaction logic for EasyTableWindow.xaml
    /// </summary>
    public partial class EasyTableWindow : Window {
        ...
        public EasyTableWindow() { 
            ...
            SetHiddenImages();
            gameFunctions = new GameFunctions(ifTimerMode, this, "EasyTableWindow", ref _timerLabel, ref _lifePointsProgressBar, ref _roundLevelLabel, ref hiddenImages);
        ...
        private void EasyTableWindow_Closing(object sender, System.ComponentModel.CancelEventArgs e) {
            e.Cancel = true;
